...
export const dataProgCard = [
  { firstHeader: null, firstName: null, secondHeader: null, secondName: null, opinio: 0, modal: false },
  {
...
export const gradesData = ['Pre K1', 'Pre K2', 'Kindergarten 1', 'Kindergarten 2', 'Grade 1']
...
export const admissionsUrls = [
  ...
  { url: '/application/principial-approval', name: 'Principal Approval', key: 3 },
...
export const chipData = [
  { label: 'Dharma Theja', styleChip: 'outlined', image: mainavatar, style: { height: 24 } },
  {
    label: 'Ramesh Kodali',
    styleChip: 'outlined',
    image: mainavatar,
  ...
  { label: 'Gopal Kodali ', styleChip: 'outlined', image: mainavatar, style: { height: 24 } },
  {
