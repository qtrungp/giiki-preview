...
import BasicPanel from '@pages/basic-panel'
...
import Dashboard from '@pages/admission-module/dashboard'
import AddmissionsOverview from '@pages/admission-module/admissions-overview'
...
import NotifcationsPage from '@pages/notifcations'
import TasksSettings from '@pages/tasks-settings'
import UserSettings from '@pages/user-settings'
import EditTemplate from '@pages/edit-template'
import AdmissionApprovals from '@pages/admission-module/admission-approvals'
